...
class Command(BaseCommand):
    ...
    def flush_table(self, *model):
        ...
        with connection.cursor() as cursor:
            cursor.execute(
                f"TRUNCATE TABLE {model[0]._meta.db_table} RESTART IDENTITY CASCADE"
            )

        self.stdout.write("Flushing data from Image table...\n")
        with connection.cursor() as cursor:
            cursor.execute(
                f"TRUNCATE TABLE {model[1]._meta.db_table} RESTART IDENTITY CASCADE"
            )
    ...
    def create_posts(self):
        try:
            ...
            posts_data = [
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Nature")
                    .first()
                    .id,
                    "images": [
                        "posts/images/iceland_1.jpg",
                        "posts/images/iceland_2.jpg",
                        "posts/images/iceland_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/future_tech_1.jpg",
                        "posts/images/future_tech_2.jpg",
                        "posts/images/future_tech_3.jpg",
                    ],
                ...
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Food")
                    .first()
                    .id,
                    "images": [
                        "posts/images/french_cuisine_1.jpg",
                        "posts/images/french_cuisine_2.jpg",
                        "posts/images/french_cuisine_3.jpg",
                    ],
                ...
                {
                    "author_id": 3,
                    "category_id": categories.filter(name="Fashion")
                    .first()
                    .id,
                    "images": [
                        "posts/images/streetwearfashion_1.jpg",
                        "posts/images/streetwearfashion_2.jpg",
                        "posts/images/streetwearfashion_3.jpg",
                    ],
                ...
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Health")
                    .first()
                    .id,
                    "images": [
                        "posts/images/mental_health_1.jpg",
                        "posts/images/mental_health_2.jpg",
                        "posts/images/mental_health_3.jpg",
                    ],
                ...
                {
                    "author_id": 3,
                    "category_id": categories.filter(name="Sports")
                    .first()
                    .id,
                    "images": [
                        "posts/images/extreme_sports_1.jpg",
                        "posts/images/extreme_sports_2.jpg",
                        "posts/images/extreme_sports_3.jpg",
                    ],
                ...
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Music")
                    .first()
                    .id,
                    "images": [
                        "posts/images/music_streaming_1.jpg",
                        "posts/images/music_streaming_2.jpg",
                        "posts/images/music_streaming_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/television_golden_1.jpg",
                        "posts/images/television_golden_2.jpg",
                        "posts/images/television_golden_3.jpg",
                    ],
                ...
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Books")
                    .first()
                    .id,
                    "images": [
                        "posts/images/power_reading_1.jpg",
                        "posts/images/power_reading_2.jpg",
                        "posts/images/power_reading_3.jpg",
                    ],
                ...
                {
                    "author_id": 3,
                    "category_id": categories.filter(name="Art")
                    .first()
                    .id,
                    "images": [
                        "posts/images/contemporary_art_1.jpg",
                        "posts/images/contemporary_art_2.jpg",
                        "posts/images/contemporary_art_3.jpg",
                    ],
                ...
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Science")
                    .first()
                    .id,
                    "images": [
                        "posts/images/space_exploration_1.jpg",
                        "posts/images/space_exploration_2.jpg",
                        "posts/images/space_exploration_3.jpg",
                    ],
                ...
                {
                    "author_id": 3,
                    "category_id": categories.filter(name="Business")
                    .first()
                    .id,
                    "images": [
                        "posts/images/ecommerce_evolution_1.jpg",
                        "posts/images/ecommerce_evolution_2.jpg",
                        "posts/images/ecommerce_evolution_3.jpg",
                    ],
                ...
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Education")
                    .first()
                    .id,
                    "images": [
                        "posts/images/lifelong_learning_1.jpg",
                        "posts/images/lifelong_learning_2.jpg",
                        "posts/images/lifelong_learning_3.jpg",
                    ],
                ...
                {
                    "author_id": 3,
                    "category_id": categories.filter(name="Culture")
                    .first()
                    .id,
                    "images": [
                        "posts/images/exploring_japan_1.jpg",
                        "posts/images/exploring_japan_2.jpg",
                        "posts/images/exploring_japan_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/future_ai_1.jpg",
                        "posts/images/future_ai_2.jpg",
                        "posts/images/future_ai_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/italian_pasta_1.jpg",
                        "posts/images/italian_pasta_2.jpg",
                        "posts/images/italian_pasta_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/fashion_trends_1.jpg",
                        "posts/images/fashion_trends_2.jpg",
                        "posts/images/fashion_trends_3.jpg",
                    ],
                ...
                {
                    "author_id": 3,
                    "category_id": categories.filter(name="Travel")
                    .first()
                    .id,
                    "images": [
                        "posts/images/world_wonders_1.jpg",
                        "posts/images/world_wonders_2.jpg",
                        "posts/images/world_wonders_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/future_technology_1.jpg",
                        "posts/images/future_technology_2.jpg",
                        "posts/images/future_technology_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/delicious_recipes_1.jpg",
                        "posts/images/delicious_recipes_2.jpg",
                        "posts/images/delicious_recipes_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/latest_fashion_trends_1.jpg",
                        "posts/images/latest_fashion_trends_2.jpg",
                        "posts/images/latest_fashion_trends_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/healthy_lifestyle_1.jpg",
                        "posts/images/healthy_lifestyle_2.jpg",
                        "posts/images/healthy_lifestyle_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/artificial_intelligence_in_health_care_1.jpg",
                        "posts/images/artificial_intelligence_in_health_care_2.jpg",
                        "posts/images/artificial_intelligence_in_health_care_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/quantum_computing_1.jpg",
                        "posts/images/quantum_computing_2.jpg",
                        "posts/images/quantum_computing_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/5g_technology_1.jpg",
                        "posts/images/5g_technology_2.jpg",
                        "posts/images/5g_technology_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/blockchain_technology_1.jpg",
                        "posts/images/blockchain_technology_2.jpg",
                        "posts/images/blockchain_technology_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/autonomous_vehicles_1.jpg",
                        "posts/images/autonomous_vehicles_2.jpg",
                        "posts/images/autonomous_vehicles_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/k_pop_influence_1.jpg",
                        "posts/images/k_pop_influence_2.jpg",
                        "posts/images/k_pop_influence_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/indigenous_art_1.jpg",
                        "posts/images/indigenous_art_2.jpg",
                        "posts/images/indigenous_art_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/street_food_culture_1.jpg",
                        "posts/images/street_food_culture_2.jpg",
                        "posts/images/street_food_culture_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/streaming_impact_1.jpg",
                        "posts/images/streaming_impact_2.jpg",
                        "posts/images/streaming_impact_3.jpg",
                    ],
                ...
                },
                {
                    ...
                    .id,
                    "images": [
                        "posts/images/sustainable_fashion_1.jpg",
                        "posts/images/sustainable_fashion_2.jpg",
                        "posts/images/sustainable_fashion_3.jpg",
                    ],
                    "hero_image": "posts/hero_images/sustainable_fashion.jpg",
                    "title": "The Rise of Sustainable Fashion",
                    "short_content": "Sustainable fashion is gaining momentum as consumers demand eco-friendly and ethical clothing. Brands are using recycled materials and ethical labor practices. This movement aims to reduce the environmental impact of the fashion industry. Sustainable fashion is not just a trend but a necessary shift for the future.",
                    "main_content": "Sustainable fashion is transforming the industry as consumers become more aware of the environmental and social impact of their clothing choices. This movement emphasizes the use of eco-friendly materials, such as organic cotton, recycled polyester, and biodegradable fabrics. Brands are also adopting ethical labor practices, ensuring fair wages and safe working conditions for garment workers. The goal is to reduce the fashion industry's carbon footprint, which is one of the largest contributors to global pollution. Initiatives like clothing rental services, second-hand shopping, and upcycling are gaining popularity, encouraging consumers to rethink their consumption habits. High-profile designers and brands, such as Stella McCartney and Patagonia, are leading the charge by integrating sustainability into their business models. While challenges like higher costs and limited availability remain, the sustainable fashion movement is gaining traction. It represents a necessary shift toward a more responsible and environmentally conscious industry, proving that style and sustainability can go hand in hand.",
                },
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Fashion")
                    ...
                    .id,
                    "images": [
                        "posts/images/streetwear_influence_1.jpg",
                        "posts/images/streetwear_influence_2.jpg",
                        "posts/images/streetwear_influence_3.jpg",
                    ],
                    "hero_image": "posts/hero_images/streetwear_influence.jpg",
                    "title": "The Influence of Streetwear on High Fashion",
                    "short_content": "Streetwear has transitioned from urban subculture to high fashion runways. Brands like Supreme and Off-White collaborate with luxury labels. This blend of casual and couture has redefined modern fashion. Streetwear's influence highlights the growing importance of youth culture in the industry.",
                    "main_content": "Streetwear, once rooted in urban subcultures and skateboarding communities, has become a dominant force in high fashion. Brands like Supreme, Off-White, and A Bathing Ape have collaborated with luxury labels such as Louis Vuitton and Gucci, blurring the lines between casual and couture. This fusion has redefined modern fashion, making hoodies, sneakers, and graphic tees staples on high-fashion runways. The rise of streetwear reflects the growing influence of youth culture and the democratization of fashion, where accessibility and individuality are prioritized. Social media has played a significant role in this shift, with influencers and celebrities showcasing streetwear styles to millions of followers. Designers like Virgil Abloh, the founder of Off-White, have become cultural icons, bridging the gap between streetwear and high fashion. While some critics argue that this trend dilutes the exclusivity of luxury brands, others see it as a refreshing evolution. Streetwear's influence underscores the dynamic nature of fashion, where boundaries are constantly being redefined.",
                },
                {
                    "author_id": 3,
                    "category_id": categories.filter(name="Fashion")
                    ...
                    .id,
                    "images": [
                        "posts/images/vintage_fashion_1.jpg",
                        "posts/images/vintage_fashion_2.jpg",
                        "posts/images/vintage_fashion_3.jpg",
                    ],
                    "hero_image": "posts/hero_images/vintage_fashion.jpg",
                    "title": "The Return of Vintage Fashion",
                    "short_content": "Vintage fashion is making a comeback, with consumers embracing second-hand and retro styles. Thrift stores and online platforms like Depop are thriving. This trend reflects a desire for unique, sustainable clothing. Vintage fashion allows individuals to express their individuality while reducing waste.",
                    "main_content": "Vintage fashion is experiencing a resurgence as more people seek unique, sustainable clothing options. Thrift stores, flea markets, and online platforms like Depop and Poshmark have become go-to destinations for finding retro styles from the '70s, '80s, and '90s. This trend is driven by a desire to stand out from mass-produced fast fashion and to make environmentally conscious choices. Vintage clothing offers a way to express individuality while reducing textile waste, as it gives old garments a new life. Celebrities and influencers have also embraced vintage fashion, often spotted wearing iconic pieces from past decades. High-end designers are even incorporating vintage elements into their collections, further legitimizing the trend. Beyond its aesthetic appeal, vintage fashion represents a shift toward mindful consumption and a rejection of disposable culture. As the movement grows, it highlights the timelessness of well-crafted clothing and the importance of preserving fashion history.",
                },
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Fashion")
                    ...
                    .id,
                    "images": [
                        "posts/images/fashion_activism_1.jpg",
                        "posts/images/fashion_activism_2.jpg",
                        "posts/images/fashion_activism_3.jpg",
                    ],
                    "hero_image": "posts/hero_images/fashion_activism.jpg",
                    "title": "The Power of Fashion Activism",
                    "short_content": "Fashion activism uses clothing as a tool for social and political change. Designers and brands are addressing issues like climate change and gender equality. Campaigns and runway shows often carry powerful messages. Fashion activism proves that clothing can be more than just aesthetics—it can be a statement.",
                    "main_content": "Fashion activism is a growing movement that leverages clothing and design to advocate for social and political change. Designers and brands are using their platforms to address pressing issues such as climate change, gender equality, and racial justice. For example, Vivienne Westwood has long been known for her eco-conscious designs and activism, while brands like Gucci have launched campaigns promoting diversity and inclusion. Runway shows have become stages for powerful statements, with models wearing slogans and symbols that challenge societal norms. Fashion activism also extends to grassroots initiatives, such as clothing drives and community projects that support marginalized groups. This movement highlights the potential of fashion to go beyond aesthetics and serve as a medium for advocacy. By wearing and supporting activist fashion, individuals can express their values and contribute to meaningful change. Fashion activism demonstrates that clothing is not just about looking good—it’s about making a difference.",
                },
                {
                    "author_id": 3,
                    "category_id": categories.filter(name="Fashion")
                    ...
                    .id,
                    "images": [
                        "posts/images/gender_neutral_fashion_1.jpg",
                        "posts/images/gender_neutral_fashion_2.jpg",
                        "posts/images/gender_neutral_fashion_3.jpg",
                    ],
                    ...
                    "main_content": "Gender-neutral fashion is challenging traditional norms by creating clothing that transcends gender boundaries. Designers like Telfar, Rad Hourani, and Palomo Spain are leading the way with collections that prioritize inclusivity and self-expression. This trend reflects a broader cultural shift toward recognizing and celebrating diverse identities. Gender-neutral fashion allows individuals to wear what resonates with them, free from societal expectations. Retailers are also embracing this movement, with brands like Zara and H&M launching gender-neutral lines. The rise of gender-neutral fashion is closely tied to conversations about gender fluidity and the rejection of binary thinking. It empowers people to express themselves authentically, whether through tailored suits, flowing dresses, or oversized streetwear. While the industry still has progress to make, gender-neutral fashion represents a significant step toward a more inclusive and accepting world. It proves that clothing can be a powerful tool for breaking down barriers and fostering understanding.",
                },
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Fashion")
                    ...
                    .id,
                    "images": [
                        "posts/images/technology_impact_on_fashion_1.jpg",
                        "posts/images/technology_impact_on_fashion_2.jpg",
                        "posts/images/technology_impact_on_fashion_3.jpg",
                    ],
                    "hero_image": "posts/hero_images/technology_impact_on_fashion.jpg",
                    "title": "The Impact of Technology on Fashion",
                    "short_content": "Technology is revolutionizing the fashion industry, from design to retail. 3D printing, AI, and virtual reality are transforming how clothes are made and sold. Online shopping and virtual try-ons are enhancing the customer experience. Technology is making fashion more innovative, accessible, and personalized.",
                    "main_content": "Technology is reshaping the fashion industry at every stage, from design and production to retail and customer experience. Innovations like 3D printing are enabling designers to create intricate, customizable garments with minimal waste. Artificial intelligence (AI) is being used to predict trends, optimize supply chains, and personalize shopping experiences. Virtual reality (VR) and augmented reality (AR) are revolutionizing how consumers interact with fashion, offering virtual try-ons and immersive runway shows. E-commerce platforms have made fashion more accessible, allowing people to shop from anywhere in the world. Social media and influencer marketing have also transformed how brands connect with their audiences. Additionally, wearable technology, such as smart fabrics and fitness trackers, is blending fashion with functionality. These advancements are not only making the industry more efficient but also more inclusive and sustainable. As technology continues to evolve, it promises to push the boundaries of what fashion can achieve, creating a future where innovation and creativity go hand in hand.",
                },
                {
                    "author_id": 3,
                    "category_id": categories.filter(name="Travel")
                    ...
                    .id,
                    "images": [
                        "posts/images/rise_of_sustainable_travel_1.jpg",
                        "posts/images/rise_of_sustainable_travel_2.jpg",
                        "posts/images/rise_of_sustainable_travel_3.jpg",
                    ],
                    "hero_image": "posts/hero_images/rise_of_sustainable_travel.jpg",
                    "title": "The Rise of Sustainable Travel",
                    "short_content": "Sustainable travel is gaining popularity as travelers seek eco-friendly and responsible tourism options. This includes reducing carbon footprints, supporting local communities, and preserving natural habitats. Eco-lodges and green certifications are becoming more common. Sustainable travel ensures that tourism benefits both people and the planet.",
                    "main_content": "Sustainable travel is a growing trend as more travelers prioritize eco-friendly and responsible tourism practices. This movement focuses on minimizing the environmental impact of travel by reducing carbon emissions, conserving water, and avoiding single-use plastics. It also emphasizes supporting local communities by staying in locally-owned accommodations, eating at local restaurants, and purchasing handmade goods. Eco-lodges and hotels with green certifications, such as LEED or EarthCheck, are becoming increasingly popular. Sustainable travel also involves respecting natural habitats and wildlife, avoiding activities that exploit animals, and participating in conservation efforts. Destinations like Costa Rica, Iceland, and New Zealand are leading the way in promoting sustainable tourism. Travelers can contribute by choosing direct flights, packing light, and offsetting their carbon emissions. Sustainable travel not only helps protect the environment but also enriches the travel experience by fostering deeper connections with local cultures and ecosystems. It’s a way to ensure that tourism benefits both people and the planet for generations to come.",
                },
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Travel")
                    ...
                    .id,
                    "images": [
                        "posts/images/impact_of_tech_on_travel_1.jpg",
                        "posts/images/impact_of_tech_on_travel_2.jpg",
                        "posts/images/impact_of_tech_on_travel_3.jpg",
                    ],
                    "hero_image": "posts/hero_images/impact_of_tech_on_travel.jpg",
                    "title": "The Impact of Technology on Travel",
                    "short_content": "Technology is revolutionizing the travel industry, making it easier and more personalized. Apps and platforms streamline booking, navigation, and communication. Virtual reality allows travelers to explore destinations before visiting. Technology is enhancing the travel experience, from planning to the journey itself.",
                    "main_content": "Technology has transformed the way we travel, making it more convenient, efficient, and personalized. Travel apps and platforms like Airbnb, Booking.com, and Google Maps have streamlined the process of booking accommodations, finding attractions, and navigating unfamiliar places. Mobile check-ins, e-tickets, and digital passports have reduced the need for physical documents, saving time and reducing stress. Virtual reality (VR) is allowing travelers to explore destinations and hotels before making a decision, providing a glimpse of what to expect. Artificial intelligence (AI) is being used to offer personalized travel recommendations based on user preferences and behavior. Social media platforms like Instagram and TikTok inspire travelers with stunning visuals and insider tips. Additionally, translation apps and portable Wi-Fi devices have made it easier to communicate and stay connected while abroad. Technology is also improving safety, with real-time updates on weather, traffic, and local conditions. As technology continues to evolve, it promises to make travel more accessible and enjoyable, enhancing every aspect of the journey from planning to the experience itself.",
                },
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Travel")
                    ...
                    .id,
                    "images": [
                        "posts/images/popularity_of_solo_traveling_1.jpg",
                        "posts/images/popularity_of_solo_traveling_2.jpg",
                        "posts/images/popularity_of_solo_traveling_3.jpg",
                    ],
                    "hero_image": "posts/hero_images/popularity_of_solo_traveling.jpg",
                    "title": "The Growing Popularity of Solo Travel",
                    "short_content": "Solo travel is on the rise as more people seek independence and self-discovery. It offers the freedom to explore at your own pace and step out of your comfort zone. Destinations like Japan, Iceland, and Thailand are popular among solo travelers. Solo travel empowers individuals to build confidence and create unforgettable memories.",
                    "main_content": "Solo travel has become increasingly popular as more people seek independence, adventure, and self-discovery. Traveling alone offers the freedom to create your own itinerary, explore at your own pace, and immerse yourself in new cultures without compromise. It also provides an opportunity to step out of your comfort zone, meet new people, and build confidence. Destinations like Japan, Iceland, and Thailand are particularly popular among solo travelers due to their safety, affordability, and welcoming atmospheres. Many accommodations, such as hostels and boutique hotels, cater to solo travelers by offering communal spaces and organized activities. Solo travel also encourages mindfulness and self-reflection, allowing individuals to disconnect from daily stresses and reconnect with themselves. While safety and planning are important considerations, the rewards of solo travel—such as unforgettable memories and personal growth—are immense. It’s a transformative experience that empowers individuals to see the world on their own terms.",
                },
                {
                    "author_id": 2,
                    "category_id": categories.filter(name="Travel")
                    ...
                    .id,
                    "images": [
                        "posts/images/revival_of_cultural_tourism_1.jpg",
                        "posts/images/revival_of_cultural_tourism_2.jpg",
                        "posts/images/revival_of_cultural_tourism_3.jpg",
                    ],
                    "hero_image": "posts/hero_images/revival_of_cultural_tourism.jpg",
                    "title": "The Revival of Cultural Tourism",
                    "short_content": "Cultural tourism is making a comeback as travelers seek authentic and immersive experiences. This includes visiting historical sites, attending local festivals, and learning traditional crafts. Cultural tourism fosters a deeper understanding of different cultures. It also supports local economies and preserves heritage.",
                    "main_content": "Cultural tourism is experiencing a revival as travelers increasingly seek authentic and immersive experiences that go beyond typical tourist attractions. This form of tourism involves visiting historical sites, museums, and cultural landmarks, as well as participating in local festivals, workshops, and traditional ceremonies. It allows travelers to gain a deeper understanding of the history, traditions, and values of different cultures. Destinations like Italy, India, and Peru are renowned for their rich cultural heritage, offering experiences such as exploring ancient ruins, tasting regional cuisines, and learning traditional crafts. Cultural tourism also plays a vital role in supporting local economies by creating jobs and preserving heritage. Many communities are actively promoting their cultural assets to attract visitors while ensuring that tourism benefits residents. Travelers can contribute by respecting local customs, supporting small businesses, and engaging with communities in meaningful ways. Cultural tourism not only enriches the travel experience but also fosters mutual respect and appreciation among people from different backgrounds.",
                },
            ]
            for post_data in posts_data:
                ...
                for image_path in post_data["images"]:
                    ...
                    self.stdout.write(
                        self.style.SUCCESS(
                            f"Successfully added image '{image_path}' to post '{post.title}'"
                        )
                    )
